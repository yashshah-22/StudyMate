...
const TakeTest = ({ subject, userCategory, userEmail ,unsCategory}) => {

  const isDisabled = userCategory !== unsCategory;
  ...
  return (
    <div className="take-test">
      ...
      {isDisabled ? (
        ...
        <Link to={`/test/${subject}`}><button>Start Test for {subject}</button></Link>
      )}
    </div>
  );
};
